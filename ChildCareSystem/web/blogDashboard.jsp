        ...
        <div class="sidebar" style: background="#3287a8">
            ...
            <div class ="sidebar-menu">
                <ul>
                    ...
                    <li style="padding-left:0.25rem">
                        <a href="thong-ke-bai-viet" class="active" class="btn btn-outline-light" style="border: none; border-radius: 30px 0px 0px 30px;text-align: left"><span id="side-bar-icon" class="fas fa-file-alt"></span>
