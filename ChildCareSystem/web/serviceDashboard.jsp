        ...
        <div class="sidebar" style: background="#3287a8">
            ...
            <div class ="sidebar-menu">
                <ul>
                    ...
                    <li style="padding-left:0.25rem">
                        <a href="thong-ke-Dich-vu" class="active" class="btn btn-outline-light" style="border: none; border-radius: 30px 0px 0px 30px;text-align: left"><span id="side-bar-icon" class="fas fa-first-aid"></span>
                            <span>Dịch vụ </span></a>
                    </li>
                    <li style="padding-left:0.25rem">
