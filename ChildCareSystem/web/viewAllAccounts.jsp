    ...
    <main>
        ...
        <div class="userPosts__container">
            <div class="userPosts__wrapper">
              <h2 class="userPosts__title">Posts status</h2>
                <div class="dropdownButton__wrapper">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                        <div class="nav flex-column nav-pills navbar-expand-lg bg-white" id="v-pills-tab" role="tablist"
                            ...
                            <a class="nav-link active" id="v-pills-changeUsername-tab" data-toggle="pill"
                                href="#allList" role="tab" aria-controls="v-pills-changeUsername" aria-selected="true"
                                onclick="toggleButton(this)">All</a>
                            <a class="nav-link" id="v-pills-changePassword-tab" data-toggle="pill" href="#acceptedList"
                                role="tab" aria-controls="v-pills-changePassword" aria-selected="false"
                                onclick="toggleButton(this)">Customer</a>
                            <a class="nav-link" id="v-pills-changePassword-tab" data-toggle="pill" href="#waitedList"
                                role="tab" aria-controls="v-pills-changePassword" aria-selected="false"
                                onclick="toggleButton(this)">Staff</a>
                            <a class="nav-link" id="v-pills-changePassword-tab" data-toggle="pill" href="#rejectedList"
                                role="tab" aria-controls="v-pills-changePassword" aria-selected="false"
                ...
                <div class="col-sm-12 table__wrapper bg-white">
                    <div class="tab-content" id="v-pills-tabContent">
                        <!--AcceptedList-->
                        <div class="tab-pane fade bg-white" id="acceptedList" role="tabpanel"
                            ...
                            <table class="table table-striped table-bordered mydatatable">
                                ...
                                <tbody id="tableBodyAccepted">
                                    <tr>
                                        ...
                                        <td>17/10/2020 17:45</td>
                                        <td class="alert alert-success">Accepted</td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td>Crawling data and tips on Instagram</td>
                                        <td>17/10/2020 17:45</td>
                                        <td class="alert alert-success">Accepted</td>
                                    </tr>
                                    <tr>
                        ...
                        <!--WaitingList-->
                        <div class="tab-pane fade bg-white" id="waitedList" role="tabpanel"
                            aria-labelledby="v-pills-changePassword-tab">
                            ...
                            <table class="table table-striped table-bordered mydatatable">
                                ...
                                <tbody id="tableBodyWaiting">
                                    <tr>
                                        ...
                                        <td>How to use Git and Github</td>
                                        <td>17/10/2020 17:45</td>
                                        <td class="alert alert-danger">Waiting</td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td>Crawling data and tips on Instagram</td>
                        ...
                        <!--RejectedList-->
                        <div class="tab-pane fade bg-white" id="rejectedList" role="tabpanel"
                            aria-labelledby="v-pills-changePassword-tab">
