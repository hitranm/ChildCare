        ...
        <div class="sidebar">
            ...
            <div class ="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="DispatchServlet?btAction=ViewReservationForManager" class="active" class="btn btn-outline-light" style="border: none; border-radius: 30px 0px 0px 30px;text-align: left"><span class="fas fa-notes-medical"></span>
