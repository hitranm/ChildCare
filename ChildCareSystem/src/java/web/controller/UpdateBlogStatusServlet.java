...
public class UpdateBlogStatusServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean result = dao.setStatus(blogID, statusID);
            if (result) {
                url = BLOG_DETAIL + "?id=" + blogID;
            } else {
                url = ERROR;
            }
        } catch (NamingException ex) {
            log("UpdateBlogStatusServlet _ Naming: " + ex.getMessage());
            url = ERROR;
        } catch (SQLException ex) {
            log("UpdateBlogStatusServlet _ SQL: " + ex.getMessage());
            url = ERROR;
